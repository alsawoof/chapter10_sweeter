...
def home():
    ...
    try:
        ...
        msg= 'There was a problem loggin you in'
        return redirect(url_for('login', msg=msg))
...
def user(username):
    ...
    try:
        ...
        #untuk memastikan pengguna yang akses sama dengan username   
...
def sign_up():
    ...
    doc = {
        ...
        "profile_pic_real": "profile_pics/profile.jpg", # a default profile image
...
def posting():
    ...
    except (jwt.ExpiredSignatureError, jwt.exception.DecodeError):
        return redirect(url_for('home'))
