        ...
        if (response["result"] === "success") {
          ...
          for (let i = 0; i < posts.length; i++) {
            ...
            if (post["thumbs_by_me"]) {
                class_thumbs = "fa-thumbs-up"
            } else {
                class_thumbs = "fa-thumbs-o-up"
            }
                                            ...
                                            <nav class="level is-mobile">
                                                <div class="level-left">
                                                    ...
                                                    <a class="level-item is-sparta" aria-label="thumbs" onclick="toggle_thumbs('${post["_id"]}', 'thumbs')">
                                                        <span class="icon is-small"><i class="fa ${class_thumbs}" aria-hidden="true"></i></span>
                                                        &nbsp;
                                                        <span class="like-num">${num2str(post["count_thumbs"])}</span>
                                                    </a>
                                                </div>
